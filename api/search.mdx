...
<Note>
  Throughout these pages, `BASE_URL` is your Souldi API base URL (for example
  `https://api.yourdomain.com`), and search is scoped to **your** catalog —
  the one tied to your `x-api-key`.
</Note>
